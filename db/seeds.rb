#event_types
['Концерт', 'Флеш-моб', 'Хода', 'Акція протесту'].each do |tn|
...
events_list.each do |name, event_type_id, place_id, host_id, url, date_begin, time_begin, date_end, time_end, about|
  Event.create(name: name, event_type_id: event_type_id, place_id: place_id, host_id: host_id, url: url, date_begin:  date_begin, time_begin: time_begin, date_end:  date_end, time_end: time_end, about: about )
end
